	...
	def post(self, request):
		...
		if serializer.is_valid(raise_exception=True):
			...
			return Response({
				...
				'message': f'hi {user.first_name} thanks for signing up a passcode has been sent to your mail'
...
class PasswordResetConfirm(GenericAPIView):
	def get(self, request, uidb64, token):
		try:
			...
			Response({'message':'token is invalid or has expired'}, status=status.HTTP_401_UNAUTHORIZED)
